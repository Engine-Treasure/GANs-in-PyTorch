...
def train(trainloader, epoch):
    ...
    for batch_idx, (x, _) in enumerate(trainloader):
        ...
        reset_grad()
        d_loss.backward()  # the gradients will flow all networks: D_xz, D_x, D_z, G_x2z, G_z2x
        d_optimizer.step()
        # ********************************
        ...
        print(
            "[{e}/{epochs}] [{i}/{steps}] Loss D: {loss_d:.6f}; Loss G: {loss_g:.6f};D(x, zhat): {d1:.6f}/{g1:.6f}; D(xhat, z): {d2:.6f}/{g2:.6f}".format(
